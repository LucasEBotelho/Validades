...
# Função para salvar o estoque e realizar o commit no GitHub
def salvar_estoque(dados):
    ...
    # Realizar commit e push para o GitHub
    subprocess.run(["git", "add", "estoque.xlsx"])  # Adiciona o arquivo alterado
    subprocess.run(["git", "commit", "-m", "Atualização de estoque"])  # Commit das mudanças
